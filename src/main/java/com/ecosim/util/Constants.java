...
public final class Constants {
    ...
    public static final int PRIORITY_FISH = 1;
    public static final int PRIORITY_DUCK = 2;
    ...
    // ===== Sight ranges (tiles) =====
    public static final double SIGHT_FISH = 6.0;
    public static final double SIGHT_DUCK = 10.0;
    ...
    // ===== Speeds (tiles/giây) =====
    public static final double SPEED_FISH = 3.0;
    public static final double SPEED_DUCK = 2.5;
    public static final double SPEED_RABBIT = 3.8;
    public static final double SPEED_DEER = 3.2;
    public static final double SPEED_WOLF = 4.2;
    public static final double SPEED_TIGER = 3.0;
    public static final double SPEED_HUNTER = 2.0;
    public static final double SPEED_ELEPHANT = 1.8;
    ...
    public static final Color COLOR_FISH = Color.web("#FF4500");
    public static final Color COLOR_DUCK = Color.web("#FFD700");
    ...
    // ===== Terrain colors =====
    public static final String TERRAIN_GRASSLAND = "#7CCD7C";
    public static final String TERRAIN_FOREST = "#2E5E2E";
    public static final String TERRAIN_WATER = "#4A90D9";
    public static final String TERRAIN_MUD = "#8B7355";
    public static final String TERRAIN_ROCK = "#696969";
    public static final String TERRAIN_BUSH = "#3A6B35";
    ...
    public static final int MAX_FISH = 30;
    public static final int MAX_DUCKS = 15;
